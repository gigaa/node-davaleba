...
let AuthService = class AuthService {
    ...
    async signUp(signUpDto) {
        ...
        if (existingUser)
            throw new common_1.ConflictException('This account already exists');
    ...
    async signIn(signInDto) {
        ...
        if (!existingUser)
            throw new common_1.UnauthorizedException("This account doesn't exist. Create a new account.");
