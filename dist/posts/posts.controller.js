...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a post (authenticated user)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List all posts (admin only)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List posts by user' }),
    (0, swagger_1.ApiParam)({ name: 'userId', description: 'Author user id' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Post MongoDB id' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a post (author or admin)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Post MongoDB id' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
